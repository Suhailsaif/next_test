...
function DefaultLayout({ children  }) {
    ...
    const apiFetch = ()=>{
        axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(`${"https://shopus.minionionbd.com/"}api/website-setup`).then((res)=>{
            // handle success
            ...
            if ((0,_utils_auth__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .Z)()) {
                ...
                if (holdData && holdData.type === "add-to-cart") {
                    if (holdData.variants) {
                        ...
                        const uri = `token=${(0,_utils_auth__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .Z)().access_token}&product_id=${holdData.id}&${variantString}${itemQueryStr}quantity=${holdData.quantity}`;
                        ...
                        const uri1 = `token=${(0,_utils_auth__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .Z)().access_token}&product_id=${holdData.id}&quantity=${holdData.quantity}`;
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        ...
                        children: maintain && /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                            ...
                            src: `${"https://shopus.minionionbd.com/" + maintain.image}`,
                            alt: "logo"
                        })
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
