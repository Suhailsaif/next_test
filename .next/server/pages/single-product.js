...
const getServerSideProps = async (context)=>{
    const res = await fetch(`${"https://shopus.minionionbd.com/"}api/product/${context.query.slug}`);
                        ...
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                ...
                                children: seller.user && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_image__WEBPACK_IMPORTED_MODULE_1___default()), {
                                    layout: "fill",
                                    src: `${seller.user.image ? "https://shopus.minionionbd.com/" + seller.user.image : "/assets/images/Group.png"}`,
                                    alt: "saller",
                                    className: "w-full h-full object-cover"
                                })
                            }),
        ...
        if (!commnets) {
            const reviews = details && details.productReviews.length > 0 && details.productReviews.map((review)=>{
                return {
                    ...
                    replys: null,
                    image: review.user.image ? "https://shopus.minionionbd.com/" + review.user.image : null
                };
            });
            setComments(reviews);
        }
                ...
                children: [
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                className: `product-des-wrapper w-full relative pt-[45px]  bg-[#F9EDF7] ${relatedProducts.length === 0 ? "pb-[109px]" : "pb-[45px]"}`,
                                ref: reviewElement,
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                            ...
                                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("textarea", {
                                                        ...
                                                        cols: "30",
                                                        rows: "6",
                                                        className: `w-full focus:ring-0 rounded focus:outline-none py-3 px-4 border  placeholder:text-sm text-sm ${reportErrors ? "border-qred" : "border-qpurplelow"}`,
